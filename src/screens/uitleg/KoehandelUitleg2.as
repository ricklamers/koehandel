package screens.uitleg
{
	...
	public class KoehandelUitleg2 extends UitlegScreen
	{
		
		private var moneyCards:Array;
		public function KoehandelUitleg2(title:String)
		{
			super(title);
			...
			description.text = "De tegenstander ziet alleen het aantal geld kaarten.\n\nHij kan het bod (blind) accepteren of een tegenbod geven.";
