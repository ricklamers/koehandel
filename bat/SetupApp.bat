...
:: Android packaging
set AND_CERT_NAME="Koehandel"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Koehandel.p12
...
set IOS_PROVISION=cert\Koehandel.mobileprovision
...
set APP_XML=src\Koehandel-app.xml
